import{Rinn as t,Class as e,Event as s,EventDispatcher as n,Model as o,ModelList as r,Schema as a,Flattenable as l,Collection as h,Template as c}from"rinn";import d from"base-64";import{signal as u,expr as f,watch as p}from"riza-signal";var m=globalThis;/*
...
*/let g={Route:n.extend({/*
	...
	*/realLocation:function(t,e){e||(e=this.location),e||(e=" ");for(var s,n=0,o=0,r=0,a="";-1!=n&&o<t.length&&r<e.length;)switch(n){case 0:if("*"==t.substr(o++,1)){n=1;break}if(t.substr(o-1,1)!=e.substr(r++,1)){a+=t.substr(o-1),n=-1;break}a+=e.substr(r-1,1);break;case 1:if("*"==t.substr(o,1)){n=3,o++;break}n=2;break;case 2:if(-1==(s=e.indexOf(t.substr(o,1),r))){a+=e.substr(r)+t.substr(o),n=-1;break}a+=e.substr(r,s-r),n=0,r=s;break;case 3:if(-1==(s=e.lastIndexOf(t.substr(o,1)))){a+=t.substr(o),n=-1;break}a+=e.substr(r,s-r),n=0,r=s}return -1!=n&&(a+=t.substr(o)),a.trim()},/*
	...
	*/navigate:function(t,e=!1){if(t=this.realLocation(t),globalThis.location.hash=="#"+t){this.refresh();return}e?globalThis.location.replace("#"+t):globalThis.location.hash=t}};g.init();/**
...
Object.keys(this._super).reverse().forEach(t=>{"ready"in this._super[t]&&this._super[t].ready()}),y.debug&&console.log(">> "+this.tagName+" READY"),this.ready(),this.onready&&this.onready(this),this.collectWatchers()}let e=this.findCustomParent(this);y.debug&&console.log(this.tagName+" ROOT IS "+(e?e.tagName:"NULL")),e&&0===e.isReady&&0!=this.isReady&&e.checkReady();let s=!1;if(e&&2===e.isReady&&2!==this.isReady&&(this.getRoot(),this.root&&this.dataset.ref&&(y.debug&&console.log(this.tagName+" REF AS `"+this.dataset.ref+"` ON "+this.root.tagName),this.root[this.dataset.ref]=this,this.root.onRefAdded(this.dataset.ref,this)),s=!0),e||2===this.isReady||(s=!0),s){if(this.isReady=2,null!==t)for(let e of t)e.checkReady();y.debug&&console.log(">> "+this.tagName+" RREADY"),Object.keys(this._super).reverse().forEach(t=>{"rready"in this._super[t]&&this._super[t].rready()}),this.rready(),this.onrootready&&this.onrootready(this)}this.readyLocked--,this.readyReenter&&!this.readyLocked&&(this.readyReenter=!1,this.checkReady()),"r-dom-probe"===this.tagName.toLowerCase()&&this.remove()},/**
	 *	Checks if all children are ready and fires the appropriate function (`ready` and/or `rready`).
	 */checkReady:function(){if(0==this.childNodes.length)return;if(this.readyLocked){this.readyReenter=!0;return}let t=!0,e=[],s=document.evaluate(".//*[contains(name(),'-')]",this,null,XPathResult.ANY_TYPE,null);for(y.debug&&console.log("# CHECKING "+this.tagName);;){let n=s.iterateNext();if(!n)break;n!==this&&this.findCustomParent(n)===this&&(y.debug&&console.log("   "+n.tagName+" = "+n.isReady),n.isReady||(t=!1),e.push(n))}t&&this.markReady(e)},/**
	 ...
	 */getFieldByPath:function(t){if(!t)return null;if("string"!=typeof t)return t;let e=t.split("."),s=m;for(e.length&&"this"==e[0]&&(s=this,e.shift()),e.length&&"root"==e[0]&&(s=this.getRoot(),e.shift());null!=s&&0!=e.length;)s=s[e.shift()];return s},/**
	...
	*/bindEvents:function(e){for(let a in e){let l=e[a];"string"==t.typeOf(l)&&(l=this[l]),l=l.bind(this);var s=a.indexOf(" "),n=-1==s?a:a.substr(0,s),o=-1==s?"":a.substr(s+1);let h=null;var r=n.indexOf("(");if(-1!=r&&(h=n.substr(r+1,n.length-r-2).split(","),n=n.substr(0,r)),"@"==o[0]){if("@this"!=o){this[o.substr(1)].addEventListener(n,l);continue}o=this}else"&"==o[0]&&(o="&this"!=o?"[data-ref='"+o.substr(1)+"']":this);if("#"==n.substr(0,1)){this.listen("propertyChanged."+n.substr(1),this,l);continue}if(null!=h)switch(n){case"keyup":case"keydown":this.listen(n,o,function(e){if(-1!=t.indexOf(h,e.keyCode.toString()))return l(e,h);e.continuePropagation=!0});continue}this.listen(n,o,l)}return this},/**
	...
	**
	**	>> Element bindRoutes ();
	*/bindRoutes:function(){if(this.routes)for(let e in this.routes){let s="!"===e[0]?g.getRoute(e.substr(1)):g.getRoute(e),n=this.routes[e];"string"===t.typeOf(n)&&(n=this[n]),"!"===e[0]?s.addHandler(n,!0,this):s.addHandler(n,!1,this)}},/**
	 * Unbinds all routes added by bindRoutes.
	 */unbindRoutes:function(){if(this.routes)for(let e in this.routes){let s="!"===e[0]?g.getRoute(e.substr(1)):g.getRoute(e),n=this.routes[e];"string"===t.typeOf(n)&&(n=this[n]),"!"===e[0]?s.removeHandler(n,!0,this):s.removeHandler(n,!1,this)}},/**
	...
	*/listen:function(e,s,n){let o=!1,r=!1;"function"==t.typeOf(s)&&(n=s,s=null),"!"==e[e.length-1]&&(e=e.substr(0,e.length-1),o=!0),"!"==e[0]&&(e=e.substr(1),r=!0);let a=null,l=null,h=this;return this.addEventListener(e,a=t=>{!1!==t.continuePropagation&&(t.firstCapture||(t.firstCapture=this,t.firstCaptureCount=0,t.queue=[]),t.firstCapture===this&&t.firstCaptureCount++,!0==o&&t.queue.push([this,s,n]),!0==r&&this._eventHandler(t,s,n))},!0),this.addEventListener(e,l=t=>{if(!1!==t.continuePropagation&&(!0!=o&&!0!=r&&this._eventHandler(t,s,n),t.firstCapture===this&&!1!==t.continuePropagation&&0==--t.firstCaptureCount)){for(;t.queue.length;){let e=t.queue.pop();e[0]._eventHandler(t,e[1],e[2])}t.continuePropagation=!1}},!1),{removed:!1,remove:function(){this.removed||(this.removed=!0,h.removeEventListener(e,a,!0),h.removeEventListener(e,l,!1))}}},/**
	...
	*/register:function(e,...s){let n;let o=class extends HTMLElement{constructor(){for(let t of(super(),this.invokeConstructor=!0,y.debug&&console.log("CREATED "+this.tagName),this._super={},Object.entries(this.constructor.prototype._super)))for(let e of(this._super[t[0]]={},Object.entries(t[1])))this._super[t[0]][e[0]]=e[1].bind(this);this.onCreated()}findRoot(t){let e=t||this.parentElement;for(;null!=e;){if("isRoot"in e&&!0===e.isRoot)return e;e=e.parentElement}return null}findCustomParent(t){let e=t?t.parentElement:this.parentElement;for(;null!=e;){if(-1!==e.tagName.indexOf("-"))return e;e=e.parentElement}return null}connectReference(t=null,e=255){this.root||(1&e)!=1||(null==t&&(t=this.findRoot()),null==t||(this.dataset.ref&&(t[this.dataset.ref]=this),this.root=t))}connectedCallback(){this.connectReference(null,1),this.invokeConstructor&&(this.invokeConstructor=!1,this.__ctor()),this.connectReference(null,2),this.elementConnected(),this.dataset.xref&&(globalThis[this.dataset.xref]=this)}disconnectedCallback(){this.root&&(this.dataset.ref&&(this.root.onRefRemoved(this.dataset.ref,this),delete this.root[this.dataset.ref]),this.root=null),this.elementDisconnected(),this.dataset.xref&&delete globalThis[this.dataset.xref]}};t.override(o.prototype,y);let r={},a={},l=t.clone(y.events),h=!0,c=!0,d=!0;for(let e=0;e<s.length;e++)if(s[e]){if("string"==t.typeOf(s[e])){let o=s[e];if(s[e]=b[o],!s[e])continue;for(let n in a[o]={},s[e])"function"==t.typeOf(s[e][n])&&(a[o][n]=s[e][n]);h=!1,c=!1,d=!1,n=!1}else y.preparePrototype(s[e]),n=!0;"_super"in s[e]&&t.override(a,s[e]._super),"events"in s[e]&&t.override(l,s[e].events),t.override(o.prototype,s[e]),t.override(r,s[e]),n&&(!h&&"init"in s[e]&&(h=!0),!c&&"ready"in s[e]&&(c=!0),!d&&"rready"in s[e]&&(d=!0))}let u=function(){};return h||(o.prototype.init=u,r.init=u),c||(o.prototype.ready=u,r.ready=u),d||(o.prototype.rready=u,r.rready=u),o.prototype._super=a,o.prototype.events=l,r._super=a,r.events=l,customElements.define(e,o),b[e]=r,v[e]=o,o},/*
	**	Expands an already created custom element with the specified prototype(s).
	**
	**	>> void expand (string elementName, ...object protos);
	*/expand:function(e,...s){if(!(e in b))return;let n=b[e],o=v[e],r=n._super,a=n.events;for(let e of s)y.preparePrototype(e),"_super"in e&&t.override(r,e._super),"events"in e&&t.override(a,e.events),t.override(o.prototype,e),t.override(n,e);o.prototype._super=r,o.prototype.events=a,n._super=r,n.events=a},/*
	**	Appends a hook to a function of a custom element.
	*/hookAppend:function(e,s,n){if(!(e in b))return;let o=t.hookAppend(b[e],s,n),r=t.hookAppend(v[e].prototype,s,n);return{unhook:function(){o.unhook(),r.unhook()}}},/*
	**	Prepends a hook to a function of a custom element.
	*/hookPrepend:function(e,s,n){if(!(e in b))return;let o=t.hookPrepend(b[e],s,n),r=t.hookPrepend(v[e].prototype,s,n);return{unhook:function(){o.unhook(),r.unhook()}}},/**
	...
	*/":setClassUnique":function(t,e){let s=e.source;s&&(s.querySelectorParent(t[2]).querySelectorAll(t[3]).forEach(e=>e.classList.remove(t[1])),s.classList.add(t[1]))}};y.debug=!1,y.register("r-elem",{}),y.register("r-dom-probe",{}),/* ****************************************** *//**
 ...
 */let _={/**
	 ...
	 */packageBegin:function(){this.flags&_.REQUEST_PACKAGE_SUPPORTED&&this._requestPackage++},/**
	 * Finishes "package-mode" and a single API request with the currently constructed package will be sent.
	 */packageEnd:function(t){this.flags&_.REQUEST_PACKAGE_SUPPORTED&&this._requestPackage&&(--this._requestPackage||this.packageSend(t))},/**
	 ...
	 */batch:function(t,e=null){if(!(this.flags&_.REQUEST_PACKAGE_SUPPORTED)){t(),e&&e();return}this.packageBegin(),t(),this.packageEnd(e)},/**
	 * Sends a single API request with the currently constructed package and maintains package-mode.
	 */packageSend:function(t){if(!(this.flags&_.REQUEST_PACKAGE_SUPPORTED)||!this._packageData.length)return;let e=this._packageData;this._packageData=[];for(var s="",n=0;n<e.length;n++)s+="r"+n+","+d.encode(this.encodeParams(e[n][2]))+";";this._showProgress(),this.apiCall({rpkg:s},(s,n)=>{this._hideProgress();for(let t=0;t<e.length;t++)try{var o=s["r"+t];if(!o){null!=e[t][1]&&e[t][1](e[t][2]);continue}null!=e[t][0]&&this.responseFilter(o,e[t][2])&&e[t][0](o,e[t][2])}catch(t){}t&&t()},t=>{this._hideProgress();for(let t=0;t<e.length;t++)null!=e[t][1]&&e[t][1](e[t][2])})},/**
	 * Adds CSS class 'busy' to the HTML root element, works only if running inside a browser.
	 */_showProgress:function(){"document"in m&&(this._requestLevel++,this._requestLevel>0&&m.document.documentElement.classList.add("busy"))},/**
	 * Removes the 'busy' CSS class from the HTML element.
	 */_hideProgress:function(){"document"in m&&(this._requestLevel--,this._requestLevel||setTimeout(()=>{0===this._requestLevel&&m.document.documentElement.classList.remove("busy")},250))},/**
	 * Sets an HTTP header.
	 ...
	 */apiCall:function(t,e,s,n=null,o=null,r=""){let a=this.getUrl(r);if(this.flags&_.UNIQUE_STAMP&&(a=this.appendParam(a,"_="+Date.now())),"GET"!=(n=n?n.toUpperCase():null)&&"POST"!=n&&(n="auto"),null===o&&(o=this.retries),this._requestPackage&&this.flags&_.REQUEST_PACKAGE_SUPPORTED){t instanceof FormData||(t={...t}),this._packageData.push([e,s,t]);return}this._showProgress();let l=t,h={mode:this.flags&_.DISABLE_CORS?"no-cors":"cors",headers:{Accept:"text/html,application/xhtml+xml,application/xml,application/json;q=0.9",...this.headers},method:n,body:null,multipart:!1};if(this.flags&_.INCLUDE_CREDENTIALS&&(h.credentials="include"),"string"==typeof l||l instanceof Blob)"string"==typeof l?"<"===l[0]?l.endsWith("</soap:Envelope>")?h.headers["Content-Type"]="application/soap+xml":h.headers["Content-Type"]="application/xml":"{"===l[0]||"["===l[0]?h.headers["Content-Type"]="application/json":h.headers["Content-Type"]="application/octet-stream":h.headers["Content-Type"]=l.type,h.method="POST",h.body=l;else{if(!(l instanceof FormData))for(let e in l=new FormData,t)t[e]instanceof File||t[e]instanceof Blob?l.append(e,t[e],t[e].name):l.append(e,t[e]);for(let t of l.entries())if(t[1]instanceof File||t[1]instanceof Blob){h.method="POST",h.multipart=!0;break}if(this.useReq64&&this.flags&_.REQ64_SUPPORTED&&!h.multipart){let t=new FormData;t.append("req64",d.encode(this.encodeParams(l))),l=t}if("auto"==h.method){let t=0;for(let e of(h.method="GET",l.entries()))if((t+=e[0].length+e[1].length+2)>960){h.method="POST";break}}"GET"==h.method?a=this.appendParam(a,this.encodeParams(l)):h.multipart?h.body=l:(h.headers["Content-Type"]="application/x-www-form-urlencoded",h.body=this.encodeParams(l))}m.fetch(a,h).then(t=>this.decodeResult(t)).then(s=>{if(this._hideProgress(),e&&this.responseFilter(s,t))try{e(s,t)}catch(t){}}).catch(a=>{this._hideProgress(),0==o?s&&s(a,t):this.apiCall(l,e,s,n,o-1,r)})},/**
	 * Decodes a result obtained using fetch into a usable object.
	 */decodeResult:function(t){let e=t.headers.get("content-type").split(";")[0].toLowerCase();return this.flags&_.JSON_RESPONSE_SUPPORTED&&-1!==e.indexOf("json")?t.json():this.flags&_.XML_RESPONSE_SUPPORTED&&-1!==e.indexOf("xml")?new Promise((e,s)=>{t.text().then(t=>{e(t=(new DOMParser).parseFromString(t,"text/xml"))}).catch(s)}):t.blob()},/**
	 ...
	 */base64:{encode:function(t){return d.encode(t)},decode:function(t){return d.decode(t)}},/**
...
*/E=n.extend({className:"DataSource",debounceDelay:250,request:null,includeCount:!1,includeEnum:!1,includeList:!0,eid:null,count:0,list:null,enum:null,/*
	...
	*/refresh:function(t="full",e=null){"function"==typeof t&&(e=t,t="full"),this._timeout&&(clearTimeout(this._timeout),this._timeout=null);let s=()=>{this._timeout=null,_.packageBegin(),this.includeCount&&("full"===t||"filter"===t)&&this.fetchCount(),this.includeEnum&&("full"===t||"enum"===t)&&this.fetchEnum(),this.includeList&&"enum"!==t&&this.fetchList(),_.packageEnd(e)};!0===t?(t="full",s()):this._timeout=setTimeout(s,this.debounceDelay)},/*
	...
	*/delete:function(t){return new Promise((e,s)=>{this.fetchDelete(t,t=>{200==t.response?e(t):s(t.error)})})},fetchList:function(){let t={...this.request.get()};t.f=this.basePath+".list",this.dispatchEvent("listLoading"),_.fetch(t).then(t=>{this.list.setData(200==t.response?t.data:null),this.dispatchEvent("listLoaded"),this.dispatchEvent("listChanged")})},fetchEnum:function(){let t={...this.request.get()};t.f=this.basePath+".enum",this.dispatchEvent("enumLoading"),_.fetch(t).then(t=>{this.enum.setData(200==t.response?t.data:null),this.dispatchEvent("enumLoaded"),this.dispatchEvent("enumChanged")})},fetchCount:function(){let t={...this.request.get()};t.f=this.basePath+".count",this.dispatchEvent("countLoading"),_.fetch(t).then(t=>{this.count=200==t.response?t.count:0,this.dispatchEvent("countLoaded"),this.dispatchEvent("countChanged")})},fetchOne:function(t,e){let s={...this.request.get(),...t};s.f=this.basePath+".get",_.fetch(s).then(t=>{e(t)})},fetchDelete:function(t,e){let s={...this.request.get(),...t};s.f=this.basePath+".delete",_.fetch(s).then(t=>{e(t)})},fetchData:function(t){let e={...this.request.get(),...t};return"."==e.f[0]&&(e.f=this.basePath+e.f),_.fetch(e)},makeUrl:function(t){let e={...this.request.get(),...t};return"."==e.f[0]&&(e.f=this.basePath+e.f),_.makeUrl(e)}}),/*
**	Provides an interface to connect with a listing API function.
*/k=r.extend({className:"DataList",debounceDelay:250,request:null,eid:null,/*
	...
	*/refresh:function(t=null,e=null){if(this._timeout&&(clearTimeout(this._timeout),this._timeout=null),!0===t){this.dispatchEvent("listLoading"),_.fetch(this.request.get()).then(t=>{this.setData(200==t.response?t.data:null),this.dispatchEvent("listLoaded"),this.dispatchEvent("listChanged"),null!==e&&e()});return}this._timeout=setTimeout(()=>{this.refresh(!0,t)},this.debounceDelay)}});/**
...
*/let L={/**
	...
	*/interpolate:function(t,e,s,n,o/* function(data, isFinished) */){let r={},a={},l=0;for(let e in t)r[e]=0,a[e]=t[e],l++;let h=Date.now()/1e3,c=0,d=function(){let u=Date.now()/1e3;for(let o in c=u-h,h=u,r){if(r[o]==s[o])continue;r[o]+=c,r[o]>=s[o]&&(r[o]=s[o],l--);let h=n[o](r[o]/s[o]);a[o]=(1-h)*t[o]+h*e[o]}o(a,0==l),0!=l&&requestAnimationFrame(d)};d()},/* ******************************************** */Linear:{IN:function(t){return t},OUT:function(t){return t},IN_OUT:function(t){return t}},/* ******************************************** */Back:{k:1.70158,IN:function(t,e){return void 0===e&&(e=L.Back.k),t*t*((e+1)*t-e)},OUT:function(t,e){return 1-L.Back.IN(1-t,e)},IN_OUT:function(t,e){return t<.5?L.Back.IN(2*t,e)/2:L.Back.OUT((t-.5)*2,e)/2+.5}},/* ******************************************** */Bounce:{getConst:function(t){return t<1/2.75?7.5625*t*t:t<2/2.75?7.5625*(t-=1.5/2.75)*t+.75:t<2.5/2.75?7.5625*(t-=2.25/2.75)*t+.9375:7.5625*(t-=2.625/2.75)*t+.984375},IN:function(t){return 1-L.Bounce.getConst(1-t)},OUT:function(t){return L.Bounce.getConst(t)},IN_OUT:function(t){return t<.5?(1-L.Bounce.getConst(1-2*t))/2:L.Bounce.getConst((t-.5)*2)/2+.5}},/* ******************************************** */Circ:{IN:function(t){return 1-Math.sqrt(1-t*t)},OUT:function(t){return 1-L.Circ.IN(1-t)},IN_OUT:function(t){return t<.5?L.Circ.IN(2*t)/2:L.Circ.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Cubic:{IN:function(t){return t*t*t},OUT:function(t){return 1-L.Cubic.IN(1-t)},IN_OUT:function(t){return t<.5?L.Cubic.IN(2*t)/2:L.Cubic.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Expo:{IN:function(t){return Math.pow(2,12*(t-1))},OUT:function(t){return-Math.pow(2,-12*t)+1},IN_OUT:function(t){return(t*=2)<1?Math.pow(2,12*(t-1))/2:(-Math.pow(2,-12*(t-1))+2)/2}},/* ******************************************** */Power:{p:12,IN:function(t){return Math.pow(t,L.Power.p)},OUT:function(t){return 1-L.Power.IN(1-t)},IN_OUT:function(t){return t<.5?L.Power.IN(2*t)/2:L.Power.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Quad:{IN:function(t){return t*t},OUT:function(t){return 1-L.Quad.IN(1-t)},IN_OUT:function(t){return t<.5?L.Quad.IN(2*t)/2:L.Quad.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Quartic:{IN:function(t){return t*t*t*t},OUT:function(t){return 1-L.Quartic.IN(1-t)},IN_OUT:function(t){return t<.5?L.Quartic.IN(2*t)/2:L.Quartic.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Quintic:{IN:function(t){return t*t*t*t*t},OUT:function(t){return 1-L.Quintic.IN(1-t)},IN_OUT:function(t){return t<.5?L.Quintic.IN(2*t)/2:L.Quintic.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Sine:{IN:function(t){return 1-Math.sin(1.5708*(1-t))},OUT:function(t){return Math.sin(1.5708*t)},IN_OUT:function(t){return-((Math.cos(3.1416*t)-1)/2)}},/* ******************************************** */Step:{IN:function(t){return 1!=t?0:1},OUT:function(t){return 1!=t?0:1},IN_OUT:function(t){return 1!=t?0:1}}},C=e.extend({list:null,initialData:null,data:null,stack:null,block:null,timeScale:1,time:0,blockTime:0,index:0,paused:!1,finished:!1,onFinishedCallback:null,onUpdatedCallback:null,__ctor:function(){this.list=[],this.initialData={},this.data={},this.stack=[],this.block=this.list,this.reset()},__dtor:function(){},clone:function(){let t=new C;return t.list=this.list,t.initialData=this.initialData,t.reset()},onFinished:function(t){return this.onFinishedCallback=t,this},onUpdated:function(t){return this.onUpdatedCallback=t,this},// Resets the animation to its initial state.
...
update:function(e){let s,n,o;if(this.paused)return!1;if(this.index>=this.block.length)return!0;let r=0;for(this.time+=e*this.timeScale;this.index<this.block.length;){let a,l=this.block[this.index];switch(l.op){case"parallel":if(!1==l.started)for(r=0,l.blocks.length=0,l.started=!0;r<l.block.length;r++)l.blocks.push([l.block[r]]),l.indices[r]=0,l.blockTimes[r]=this.blockTime;s=this.block,n=this.index;let h=0,c=o=this.blockTime;for(r=0;r<l.blocks.length;r++)this.block=l.blocks[r],this.index=l.indices[r],this.blockTime=l.blockTimes[r],!0===this.update(0)&&h++,this.blockTime>c&&(c=this.blockTime),l.blockTimes[r]=this.blockTime,l.blocks[r]=this.block,l.indices[r]=this.index;if(this.block=s,this.index=n,this.blockTime=o,l.fn&&l.fn.call(this),h!=l.blocks.length)return!1;l.started=!1,this.blockTime=c,this.index++;break;case"serial":if(!1==l.started&&(l._block=l.block,l._index=0,l._blockTime=this.blockTime,l.started=!0),s=this.block,n=this.index,o=this.blockTime,this.block=l._block,this.index=l._index,this.blockTime=l._blockTime,r=this.update(0),l._block=this.block,l._index=this.index,l._blockTime=this.blockTime,this.block=s,this.index=n,this.blockTime=o,l.fn&&l.fn.call(this),!0!==r)return!1;l.started=!1,this.blockTime=l._blockTime,this.index++;break;case"repeat":if(!1==l.started&&(l._block=l.block,l._index=0,l._blockTime=this.blockTime,l._count=l.count,l.started=!0),s=this.block,n=this.index,o=this.blockTime,this.block=l._block,this.index=l._index,this.blockTime=l._blockTime,r=this.update(0),l._block=this.block,l._index=this.index,l._blockTime=this.blockTime,this.block=s,this.index=n,this.blockTime=o,l.fn&&l.fn.call(this),!0!==r)return!1;if(l._count<=1)return l.started=!1,this.blockTime=l._blockTime,this.index++,!1;return l._index=0,l._count--,!1;case"set":this.data[l.field]=l.value,this.index++;break;case"restart":this.index=0;break;case"wait":if(a="string"==t.typeOf(l.duration)?this.data[l.duration]:l.duration,this.time<this.blockTime+a)return!1;this.blockTime+=a,this.index++;break;case"range":if(!1==l.started&&(null===l.startValue?l._startValue=this.data[l.field]:l._startValue=l.startValue,l._endValue=l.endValue,l.started=!0),a="string"==t.typeOf(l.duration)?this.data[l.duration]:l.duration,e=this.time<this.blockTime+a?(this.time-this.blockTime)/a:1,l.easing&&1!=e?this.data[l.field]=l.easing(e)*(l._endValue-l._startValue)+l._startValue:this.data[l.field]=e*(l._endValue-l._startValue)+l._startValue,1!=e)return!1;l.started=!1,this.blockTime+=a,this.index++;break;case"rand":if(!1==l.started&&(l.started=!0,l.last=null),a="string"==t.typeOf(l.duration)?this.data[l.duration]:l.duration,e=this.time<this.blockTime+a?(this.time-this.blockTime)/a:1,l.easing&&1!=e?l.cur=~~(l.easing(e)*l.count):l.cur=~~(e*l.count),l.cur!=l.last){for(;(r=~~(Math.random()*(l.endValue-l.startValue+1))+l.startValue)==this.data[l.field];);this.data[l.field]=r,l.last=l.cur}if(1!=e)return!1;l.started=!1,this.blockTime+=a,this.index++;break;case"randt":if(a="string"==t.typeOf(l.duration)?this.data[l.duration]:l.duration,e=this.time<this.blockTime+a?(this.time-this.blockTime)/a:1,r=l.easing&&1!=e?l.easing(e)*(l.count-1):e*(l.count-1),this.data[l.field]=l.table[~~((r+l.count)%l.count)],1!=e)return!1;this.blockTime+=a,this.index++;break;case"play":l.snd.play(),this.index++;break;case"exec":l.fn.call(this,this),this.index++}}return this.block==this.list&&(this.finished||null==this.onFinishedCallback||this.onFinishedCallback(),this.pause(),this.finished=!0),!0},// Runs the subsequent commands in parallel. Should end the parallel block by calling end().
...
rand:function(t,e,s,n,o,r){return this.block.push({op:"rand",started:!1,field:t,duration:e,count:s,startValue:n,endValue:o,easing:r||null}),this},// Generates a certain amount of random numbers in the given range (inclusive). This uses a static random table to determine the next values.
randt:function(t,e,s,n,o,r){let a=[];for(let t=0;t<s;t++)a.push(t%(o-n+1)+n);for(let t=s>>2;t>0;t--){let t=~~(Math.random()*s),e=~~(Math.random()*s),n=a[e];a[e]=a[t],a[t]=n}return this.block.push({op:"randt",field:t,duration:e,count:s,startValue:n,endValue:o,table:a,easing:r||null}),this},// Plays a sound.
...
*/var x=y.register("r-tabs",{/**
     * Container element for tab content.
     */container:null,/**
     * Active tab name.
     */activeTab:null,/**
    **	Element events.
    */"event click [data-name]":function(t){if(t.continuePropagation=!0,this.dataset.baseRoute){location="#"+g.realLocation(this.dataset.baseRoute.replace("@",t.source.dataset.name));return}this.selectTab(t.source.dataset.name)},/**
    **	Initializes the Tabs element.
    */init:function(){this._routeHandler=(t,e)=>{""!=g.location&&this.querySelectorAll("[href]").forEach(t=>{t.href&&(g.location.startsWith(t.href.substr(t.href.indexOf("#")+1))?(t.classList.add("is-active"),t.classList.remove("is-inactive")):(t.classList.add("is-inactive"),t.classList.remove("is-active")),t.classList.remove("anim-ended"),t.onanimationend=()=>{t.onanimationend=null,t.classList.add("anim-ended")})}),e.route.changed&&this.showTab(e.tabName)}},/**
    **	Executed when the children of the element are ready.
    ...
    */onConnected:function(){this.dataset.baseRoute&&g.addRoute(this.dataset.baseRoute.replace("@",":tabName"),this._routeHandler)},/**
    **	Removes a handler previously added to Router if the data-base-route attribute was set.
    */onDisconnected:function(){this.dataset.baseRoute&&g.removeRoute(this.dataset.baseRoute.replace("@",":tabName"),this._routeHandler)},/**
    ...
    */selectTab:function(t){if(this.dataset.baseRoute){let e="#"+g.realLocation(this.dataset.baseRoute.replace("@",t));if(location.hash!=e){location=e;return}}this.showTab(t)}}),S=y.register("r-form",{/**
    **	Element events.
...
this._onDeactivate=(t,e)=>{this.hide()},this.hide()},/**
     ...
     */onConnected:function(){this.dataset.route?(this.route=g.addRoute(this.dataset.route,this._onActivate,this._onDeactivate),this.classList.remove("is-active"),this.classList.add("is-inactive")):(this.classList.add("is-active"),this.classList.remove("is-inactive")),this.classList.add("anim-ended")},/**
     * Removes a handler previously added to Router if the data-route attribute was set.
     */onDisconnected:function(){this.dataset.route&&g.removeRoute(this.dataset.route,this._onActivate,this._onDeactivate)},/**
...
*/P=y.register("r-list",{list:null,container:null,template:null,isEmpty:!1,isDynamicTemplate:!1,/**
    **	Executed when the children of the element are ready.
    ...
    */onItemAdded:function(t,e){"head"==e.position?"false"!=this.dataset.wrap?this.container.prepend(this.buildItem(e.id,e.item)):this.container.innerHTML=this.buildItem(e.id,e.item,!0)+this.container.innerHTML:"false"!=this.dataset.wrap?this.container.append(this.buildItem(e.id,e.item)):this.container.innerHTML+=this.buildItem(e.id,e.item,!0),this.setEmpty(!1)},/**
     ...
     */refresh:function(){this.onItemsChanged()}}),A=y.register("r-item",{/**
    **	Initializes the element.
    */init:function(){},/**
...
*/R=y.register("r-paginator",{source:null,template:null,/**
    **	Initializes the element.
...
*/w=y.register("r-table",{source:null,template:null,container:null,isEmpty:null,/**
    **	Initializes the element.
...
*/O=y.register("r-select",{list:null,container:null,value:"",/**
    **	Initializes the element.
    ...
    **	Sets the list model-list of the element.
    */setList:function(e){e&&t.isInstanceOf(e,r)&&this.list!==e&&(null!=this.list&&this.list.removeEventListener(this.eid+":*"),this.list=e,this.list.dataSource&&(this.list.dataSource.includeEnum=!0),this.list.addEventListener(this.eid+":itemsCleared",this.onItemsCleared,this),this.list.addEventListener(this.eid+":itemsChanged",this.onItemsChanged,this),this.list.addEventListener(this.eid+":itemRemoved",this.onItemsChanged,this),this.list.addEventListener(this.eid+":itemChanged",this.onItemsChanged,this),this.list.addEventListener(this.eid+":itemAdded",this.onItemsChanged,this),this.onItemsChanged())},/*
    **	Executed when the list is cleared.
    */onItemsCleared:function(t,e){this.container.textContent=""},/*
    **	Executed when the items of the list changed.
    */onItemsChanged:function(t,e){if(0==this.list.length())return;let s=this.list.getData(),n,o,r="";if(s[0].has("value")?n="value":s[0].has("id")&&(n="id"),s[0].has("label")?o="label":s[0].has("name")&&(o="name"),"blank"in this.dataset&&(r+='<option value="">'+this.dataset.blank+"</option>"),s[0].has("group")){let t={};for(let e in s.forEach(e=>t[e.get("group")]=null),t)t[e]={name:e,list:[]};s.forEach(e=>t[e.get("group")].list.push(e)),(t=Object.values(t)).forEach(t=>{r+='<optgroup label="'+t.name+'">',t.list.forEach(t=>r+='<option value="'+t.get(n)+'">'+t.get(o)+"</option>"),r+="</optgroup>"})}else s.forEach(t=>r+='<option value="'+t.get(n)+'">'+t.get(o)+"</option>");this.container.innerHTML=r,this.container.value=this.container.dataset.value},/**
     * 	Forces re-rendering of the element.
...
*/let I={/**
	...
	*/showDownload:function(t,e){var s=document.createElement("a");s.href=e,s.style.display="none",s.download=t,s.target="_blank",document.body.appendChild(s),s.click(),document.body.removeChild(s)},/**
	**	Forces the browser to show a file selection dialog.
	*/showFilePicker:function(t,e,s){var n=document.createElement("input");n.type="file",n.accept=e,n.style.display="none",n.multiple=t,document.body.appendChild(n),n.onchange=function(){s(n.files)},document.body.onfocus=function(){document.body.onfocus=null,document.body.removeChild(n)},n.click()},/**
	**	Loads a URL using FileReader and returns as a dataURL.
	*/loadAsDataUrl:function(t,e){var s=new FileReader;s.onload=function(t){e(t.target.result,null)},s.onerror=function(t){e(null,t)},s.readAsDataURL(t)},/**
	**	Loads a URL using FileReader and returns as text.
	*/loadAsText:function(t,e){var s=new FileReader;s.onload=function(t){e(t.target.result)},s.readAsText(t)},/**
	**	Loads a URL using FileReader and returns as an array buffer.
	*/loadAsArrayBuffer:function(t,e){var s=new FileReader;s.onload=function(t){e(t.target.result)},s.readAsArrayBuffer(t)},/**
	**	Loads an array of URLs using FileReader and returns them as data url.
	*/loadAllAsDataUrl:function(t,e){var s=[];if(!t||!t.length){e(s);return}var n=function(o){if(o==t.length){e(s);return}I.loadAsDataUrl(t[o],function(e,r){r||s.push({name:t[o].name,size:t[o].size,url:e}),n(o+1)})};n(0)},/*
	**	Loads a URL as an image.
	*/loadImageFromUrl:function(t,e){let s=new Image;s.onload=()=>e(s),s.onerror=()=>e(null),s.src=t}};var q=y.register("r-image-cropper",{/*
    ...
    */setImageUrl:function(t){I.loadImageFromUrl(t,t=>{this.setImage(t)})},/*
    **	Sets the image for the cropper from an HTML File object.
    */setImageFile:function(t){I.loadAsDataUrl(t,t=>{I.loadImageFromUrl(t,t=>{this.setImage(t)})})},/*
    ...
    */"event touchmove canvas":function(t){for(let e of t.changedTouches)this.pointerA.id==e.identifier?(this.pointerA.cx=e.clientX,this.pointerA.cy=e.clientY):this.pointerB.id==e.identifier&&(this.pointerB.cx=e.clientX,this.pointerB.cy=e.clientY);if(this.pointerA.active&&this.pointerB.active){let t=Math.sqrt(Math.pow(this.pointerA.sx-this.pointerB.sx,2)+Math.pow(this.pointerA.sy-this.pointerB.sy,2)),e=Math.sqrt(Math.pow(this.pointerA.cx-this.pointerB.cx,2)+Math.pow(this.pointerA.cy-this.pointerB.cy,2));this.imageScale+=(e-t)/10*.025,this.imageScale<.1&&(this.imageScale=.1),this.imageOffsX+=-this.pointerA.ix*this.imageScale+(this.pointerA.cx-this.bounds.left)-this.imageOffsX,this.imageOffsY+=-this.pointerA.iy*this.imageScale+(this.pointerA.cy-this.bounds.top)-this.imageOffsY,this.pointerA.sx=this.pointerA.cx,this.pointerA.sy=this.pointerA.cy,this.pointerB.sx=this.pointerB.cx,this.pointerB.sy=this.pointerB.cy,this.render()}else{let t=this.pointerA.active?this.pointerA:this.pointerB.active?this.pointerB:null;if(!t)return;this.translateImage(t.cx-t.sx,t.cy-t.sy),t.sx=t.cx,t.sy=t.cy}},"event touchstart canvas":function(t){for(let e of(this.imageScale0=this.imageScale,t.changedTouches))null===this.pointerA.id?(this.pointerA.id=e.identifier,this.pointerA.active=!0,this.pointerA.sx=e.clientX,this.pointerA.sy=e.clientY,this.pointerA.ix=(e.clientX-this.bounds.left-this.imageOffsX)/this.imageScale,this.pointerA.iy=(e.clientY-this.bounds.top-this.imageOffsY)/this.imageScale):null===this.pointerB.id&&(this.pointerB.id=e.identifier,this.pointerB.active=!0,this.pointerB.sx=e.clientX,this.pointerB.sy=e.clientY,this.pointerB.ix=(e.clientX-this.bounds.left-this.imageOffsX)/this.imageScale,this.pointerB.iy=(e.clientY-this.bounds.top-this.imageOffsY)/this.imageScale)},"event touchend canvas":function(t){for(let e of t.changedTouches)this.pointerA.id==e.identifier?(this.pointerA.id=null,this.pointerA.active=!1):this.pointerB.id==e.identifier&&(this.pointerB.id=null,this.pointerB.active=!1)},"event touchcancel canvas":function(t){for(let e of t.changedTouches)this.pointerA.id==e.identifier?(this.pointerA.id=null,this.pointerA.active=!1):this.pointerB.id==e.identifier&&(this.pointerB.id=null,this.pointerB.active=!1)}});let N=u,M=f,U=p,D={/**
     ...
     * @param {object} value
     */setValue:function(t,e,s,n){if(("class"===e[0]||"classList"===e[0])&&(e[0]="className"),e.length>1&&"trait"===e[0]){switch(e[1]){case"valueSignal":case"value":t.onchange=t=>n.set(t.currentTarget.value),U([n],e=>t.value=e);break;case"inputSignal":case"input":t.oninput=t=>n.set(t.currentTarget.value),U([n],e=>t.value=e);break;default:console.error("Unknown trait: "+e[1])}return}// Object used to set `style` or `class` attribute.
if(1===e.length&&"object"==typeof n)switch(e[0]){case"style":for(let e in n)U([e,n[e]],(e,s)=>t.style[e]=s);return;case"className":if(n instanceof Array)U([n],e=>{for(let s in t.className="",e)t.classList.add(e[s])});else for(let e in n)U([e,n[e]],(e,s)=>t.classList[!0==s?"add":"remove"](e));return}// Specific CSS class such as `class:hidden`.
if(2===e.length&&"className"===e[0]){U([e[1],n],(e,s)=>t.classList[!0==s?"add":"remove"](e));return}// Any other attribute/property.
for(let n=0;n<s&&t;n++)t=t[e[n]];t&&U([e[s],n],(e,s)=>t[e]=s)},/**
     * Creates a setter for a specified path inside an object.
     * @param {string[]} path 
     * @returns {(root: Element|Text, value: object) => void}
     */createSetter:function(t){let e=t.length-1;return function(s,n){D.setValue(s,t,e,n)}},/**
...
for(let s of Object.getOwnPropertyNames(t))~~s!=s&&(e[s]=t[s]);return e},/**
     ...
     */cloneNode:function(t,e=!1){if(!e&&!0===t.isCustom)throw Error("cloneNode only available as deep clone for custom elements.");if(e&&!0===t.isCustom)return t.cloneNodeCustom();let s=t.cloneNode();if(e)for(let e of t.childNodes)s.appendChild(D.cloneNode(e,!0));return(// Copy handlers and properties.
D.copyProps(t,s),"oncreated"in s&&s.oncreated(s),s)},/**
     ...
     */ensureNode:function(t,e=!1){if(t instanceof Array){for(let s=0;s<t.length;s++)t[s]=D.ensureNode(t[s],e);return t}return t instanceof Node?e?D.cloneNode(t,!0):t:document.createTextNode(t)},/**
...
if(e instanceof Array){for(;e.length>1;){let s=e.shift();s.parentElement===t&&s.remove()}e=e.shift()}let o=s,r=s;// When newNode is an array, create a document fragment for faster append of all children.
if(s instanceof Array){let t=document.createDocumentFragment();o=[],0==s.length&&(s=[document.createTextNode("")]);for(let e=0;e<s.length;e++)o.push(s[e]),t.appendChild(s[e]);r=s[0],s=t}if(!1===n){e.replaceWith(s);let t=document.createComment("");r.parentElement.insertBefore(t,r),o instanceof Array||(o=[o]),o.push(t)}else e.appendChild(s);return o},/**
     * Creates a DOM node replacer.
     * @param {Element|Text|Array<Element|Text>} refNode
     * @returns {(root: Element|Text, newNode: any) => void}
     */createReplacer:function(t){return function(e,s){t=D.replaceNode(e,t,D.ensureNode(s))}},/**
...
let n=document.createElement(t),o=[];for(let t=0;t<e.length;t+=2){let s=null;if(s=-1!==e[t].indexOf(":")?e[t].split(":"):[e[t]],e[t+1]!==D.DYNAMIC){D.setValue(n,s,s.length-1,e[t+1]);continue}o.push(D.createSetter(s))}// Attach static children.
let r=[],a=!1,l=!0;// Get indices of dynamic children and detect if any child is a custom element.
for(let t in s)!0===s[t].isCustom&&(a=!0),s[t]===D.DYNAMIC&&r.push(t);// Create and return the element builder fuction.
let h=o.length,c=r.length;return function(t,e,d=null){let u=(e,f=null)=>{let p=null;if(l||a){let t=a?D.cloneNode(n):n;for(let e in s){if(s[e]instanceof Array)throw Error("Document fragments not fully supported!");D.replaceNode(t,t,D.ensureNode(s[e],!0),!0)}a&&(p=t),l=!1}null===p&&(p=D.cloneNode(n,!0));let m="oncreated"in p,g=r.map(t=>D.createReplacer(p.childNodes[t]));for(let e=0;e<h;e++)o[e](p,t[e]);for(let t=0;t<c;t++)U([e[t],t],(t,e)=>g[e](p,t));if(null!==d)for(let t of d)for(let e in t){let s=null;s=-1!==e.indexOf(":")?e.split(":"):[e],D.setValue(p,s,s.length-1,t[e])}return null!==f&&D.copyProps(f,p),!m&&"oncreated"in p&&p.oncreated(p),p.isCustom=!0,p.cloneNode=()=>{throw Error("Use of cloneNode is forbidden in custom elements, use cloneNodeCustom instead.")},p.cloneNodeCustom=()=>u(e.map(t=>t instanceof Node&&!0===t.isCustom?t.cloneNodeCustom():t),p),p};return u(e)}}},$=g,B=y,H=y,F=_,V=E,Y=k,j=L,X=C,Q={Tabs:x,Form:S,Panel:T,List:P,Item:A,Paginator:R,Table:w,Select:O,ImageCropper:q},z=I,W={/**
	 * Database connection.
	 */db:null,/**
	 ...
	 */init:function(t,e,s){return new Promise((n,o)=>{if(!m.indexedDB){o("IndexedDB is not available in your system.");return}let r=indexedDB.open(t,e);r.onerror=t=>{let e=t.target.error+"";-1!==e.indexOf("AbortError")&&(e="\n"+r.message),o("Unable to open database: "+e)},r.onupgradeneeded=async t=>{try{let e=t.target.result,n=t.target.transaction;t.oldVersion<1&&e.createObjectStore("system",{keyPath:["name"]}),await s(e,n,t.oldVersion)}catch(t){r.message=t.message,r.transaction.abort()}},r.onsuccess=async t=>{this.db=t.target.result,n()}})},/**
	 ...
	 */forEach:function(t,e,s){return this.ensureConnected(),"function"==typeof e&&(s=e,e=null),new Promise(async(n,o)=>{let r,a;a="string"==typeof t?this.db.transaction(t,"readwrite").objectStore(t):t,(r=null===e?a.openCursor():a.openCursor(e)).onsuccess=async t=>{let e=t.target.result;if(!e||!1===await s(e.value,e)){n();return}e.continue()},r.onerror=t=>{o(t.target.error)}})},/**
	 ...
	 */getAllUnique:function(t,e=null){return this.ensureConnected(),new Promise((s,n)=>{let o=("string"==typeof t?this.db.transaction(t,"readonly").objectStore(t):t).openCursor(null,"nextunique"),r=[];o.onsuccess=t=>{let n=t.target.result;if(!n){s(r);return}r.push(e?n.value[e]:n.value),n.continue()},o.onerror=t=>{n(t.target.error)}})},/**
	 ...
	 */findOne:function(e,s=null,n=null){return this.ensureConnected(),new Promise((o,r)=>{let a=("string"==typeof e?this.db.transaction(e,"readonly").objectStore(e):e).openCursor();a.onsuccess=e=>{let r=e.target.result;if(!r){o(null);return}if(null===s||t.partialCompare(r.value,s)){if(null!==n&&t.partialCompare(r.value,n)){r.continue();return}o(r.value);return}r.continue()},a.onerror=t=>{r(t.target.error)}})},/**
	 ...
	 */insert:function(t,e){return this.ensureConnected(),new Promise((s,n)=>{let o=this.db.transaction(t,"readwrite").objectStore(t).add(e);o.onsuccess=t=>{s()},o.onerror=t=>{n(t.target.error)}})}},G=t,K=e,J=s,Z=n,tt=o,te=r,ti=a,ts=l,tn=h,to=c;export{$ as Router,B as Element,H as CElement,F as Api,V as DataSource,Y as DataList,j as Easing,X as Anim,Q as Elements,z as Utils,W as db,G as Rinn,K as Class,J as Event,Z as EventDispatcher,tt as Model,te as ModelList,ti as Schema,ts as Flattenable,tn as Collection,to as Template,N as signal,M as expr,U as watch,D as helpers};//# sourceMappingURL=riza.m.js.map
