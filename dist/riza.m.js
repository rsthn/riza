import{Rinn as t,Class as e,Event as s,EventDispatcher as n,Model as o,ModelList as r,Schema as a,Flattenable as l,Collection as h,Template as c}from"rinn";import d from"base-64";import{signal as u,expr as f,watch as p,validator as m}from"riza-signal";var g=globalThis;/*
...
Object.keys(this._super).reverse().forEach(t=>{"ready"in this._super[t]&&this._super[t].ready()}),_.debug&&console.log(">> "+this.tagName+" READY"),this.ready(),this.onready&&this.onready(this),this.collectWatchers()}let e=this.findCustomParent(this);_.debug&&console.log(this.tagName+" ROOT IS "+(e?e.tagName:"NULL")),e&&0===e.isReady&&0!=this.isReady&&e.checkReady();let s=!1;if(e&&2===e.isReady&&2!==this.isReady&&(this.getRoot(),this.root&&this.dataset.ref&&(_.debug&&console.log(this.tagName+" REF AS `"+this.dataset.ref+"` ON "+this.root.tagName),this.root[this.dataset.ref]=this,this.root.onRefAdded(this.dataset.ref,this)),s=!0),e||2===this.isReady||(s=!0),s){if(this.isReady=2,null!==t)for(let e of t)e.checkReady();_.debug&&console.log(">> "+this.tagName+" RREADY"),Object.keys(this._super).reverse().forEach(t=>{"rready"in this._super[t]&&this._super[t].rready()}),this.rready(),this.onrootready&&this.onrootready(this)}this.readyLocked--,this.readyReenter&&!this.readyLocked&&(this.readyReenter=!1,this.checkReady()),"r-dom-probe"===this.tagName.toLowerCase()&&this.remove()},/**
	...
	*/register:function(e,...s){let n;let o=class extends HTMLElement{constructor(){for(let t of(super(),this.invokeConstructor=!0,_.debug&&console.log("CREATED "+this.tagName),this._super={},Object.entries(this.constructor.prototype._super)))for(let e of(this._super[t[0]]={},Object.entries(t[1])))this._super[t[0]][e[0]]=e[1].bind(this);this.onCreated()}findRoot(t){let e=t||this.parentElement;for(;null!=e;){if("isRoot"in e&&!0===e.isRoot)return e;e=e.parentElement}return null}findCustomParent(t){let e=t?t.parentElement:this.parentElement;for(;null!=e;){if(-1!==e.tagName.indexOf("-"))return e;e=e.parentElement}return null}connectReference(t=null,e=255){this.root||(1&e)!=1||(null==t&&(t=this.findRoot()),null==t||(this.dataset.ref&&(t[this.dataset.ref]=this),this.root=t))}connectedCallback(){this.connectReference(null,1),this.invokeConstructor&&(this.invokeConstructor=!1,this.__ctor()),this.connectReference(null,2),this.elementConnected(),this.dataset.xref&&(globalThis[this.dataset.xref]=this)}disconnectedCallback(){this.root&&(this.dataset.ref&&(this.root.onRefRemoved(this.dataset.ref,this),delete this.root[this.dataset.ref]),this.root=null),this.elementDisconnected(),this.dataset.xref&&delete globalThis[this.dataset.xref]}};t.override(o.prototype,_);let r={},a={},l=t.clone(_.events),h=!0,c=!0,d=!0;for(let e=0;e<s.length;e++)if(s[e]){if("string"==t.typeOf(s[e])){let o=s[e];if(s[e]=v[o],!s[e])continue;for(let n in a[o]={},s[e])"function"==t.typeOf(s[e][n])&&(a[o][n]=s[e][n]);h=!1,c=!1,d=!1,n=!1}else _.preparePrototype(s[e]),n=!0;"_super"in s[e]&&t.override(a,s[e]._super),"events"in s[e]&&t.override(l,s[e].events),t.override(o.prototype,s[e]),t.override(r,s[e]),n&&(!h&&"init"in s[e]&&(h=!0),!c&&"ready"in s[e]&&(c=!0),!d&&"rready"in s[e]&&(d=!0))}let u=function(){};return h||(o.prototype.init=u,r.init=u),c||(o.prototype.ready=u,r.ready=u),d||(o.prototype.rready=u,r.rready=u),o.prototype._super=a,o.prototype.events=l,r._super=a,r.events=l,customElements.define(e,o),v[e]=r,y[e]=o,o},/*
	**	Expands an already created custom element with the specified prototype(s).
	**
	**	>> void expand (string elementName, ...object protos);
	*/expand:function(e,...s){if(!(e in v))return;let n=v[e],o=y[e],r=n._super,a=n.events;for(let e of s)_.preparePrototype(e),"_super"in e&&t.override(r,e._super),"events"in e&&t.override(a,e.events),t.override(o.prototype,e),t.override(n,e);o.prototype._super=r,o.prototype.events=a,n._super=r,n.events=a},/*
	**	Appends a hook to a function of a custom element.
	*/hookAppend:function(e,s,n){if(!(e in v))return;let o=t.hookAppend(v[e],s,n),r=t.hookAppend(y[e].prototype,s,n);return{unhook:function(){o.unhook(),r.unhook()}}},/*
	**	Prepends a hook to a function of a custom element.
	*/hookPrepend:function(e,s,n){if(!(e in v))return;let o=t.hookPrepend(v[e],s,n),r=t.hookPrepend(y[e].prototype,s,n);return{unhook:function(){o.unhook(),r.unhook()}}},/**
...
*/L=r.extend({className:"DataList",debounceDelay:250,request:null,eid:null,/*
...
*/let C={/**
	...
	*/interpolate:function(t,e,s,n,o/* function(data, isFinished) */){let r={},a={},l=0;for(let e in t)r[e]=0,a[e]=t[e],l++;let h=Date.now()/1e3,c=0,d=function(){let u=Date.now()/1e3;for(let o in c=u-h,h=u,r){if(r[o]==s[o])continue;r[o]+=c,r[o]>=s[o]&&(r[o]=s[o],l--);let h=n[o](r[o]/s[o]);a[o]=(1-h)*t[o]+h*e[o]}o(a,0==l),0!=l&&requestAnimationFrame(d)};d()},/* ******************************************** */Linear:{IN:function(t){return t},OUT:function(t){return t},IN_OUT:function(t){return t}},/* ******************************************** */Back:{k:1.70158,IN:function(t,e){return void 0===e&&(e=C.Back.k),t*t*((e+1)*t-e)},OUT:function(t,e){return 1-C.Back.IN(1-t,e)},IN_OUT:function(t,e){return t<.5?C.Back.IN(2*t,e)/2:C.Back.OUT((t-.5)*2,e)/2+.5}},/* ******************************************** */Bounce:{getConst:function(t){return t<1/2.75?7.5625*t*t:t<2/2.75?7.5625*(t-=1.5/2.75)*t+.75:t<2.5/2.75?7.5625*(t-=2.25/2.75)*t+.9375:7.5625*(t-=2.625/2.75)*t+.984375},IN:function(t){return 1-C.Bounce.getConst(1-t)},OUT:function(t){return C.Bounce.getConst(t)},IN_OUT:function(t){return t<.5?(1-C.Bounce.getConst(1-2*t))/2:C.Bounce.getConst((t-.5)*2)/2+.5}},/* ******************************************** */Circ:{IN:function(t){return 1-Math.sqrt(1-t*t)},OUT:function(t){return 1-C.Circ.IN(1-t)},IN_OUT:function(t){return t<.5?C.Circ.IN(2*t)/2:C.Circ.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Cubic:{IN:function(t){return t*t*t},OUT:function(t){return 1-C.Cubic.IN(1-t)},IN_OUT:function(t){return t<.5?C.Cubic.IN(2*t)/2:C.Cubic.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Expo:{IN:function(t){return Math.pow(2,12*(t-1))},OUT:function(t){return-Math.pow(2,-12*t)+1},IN_OUT:function(t){return(t*=2)<1?Math.pow(2,12*(t-1))/2:(-Math.pow(2,-12*(t-1))+2)/2}},/* ******************************************** */Power:{p:12,IN:function(t){return Math.pow(t,C.Power.p)},OUT:function(t){return 1-C.Power.IN(1-t)},IN_OUT:function(t){return t<.5?C.Power.IN(2*t)/2:C.Power.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Quad:{IN:function(t){return t*t},OUT:function(t){return 1-C.Quad.IN(1-t)},IN_OUT:function(t){return t<.5?C.Quad.IN(2*t)/2:C.Quad.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Quartic:{IN:function(t){return t*t*t*t},OUT:function(t){return 1-C.Quartic.IN(1-t)},IN_OUT:function(t){return t<.5?C.Quartic.IN(2*t)/2:C.Quartic.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Quintic:{IN:function(t){return t*t*t*t*t},OUT:function(t){return 1-C.Quintic.IN(1-t)},IN_OUT:function(t){return t<.5?C.Quintic.IN(2*t)/2:C.Quintic.OUT((t-.5)*2)/2+.5}},/* ******************************************** */Sine:{IN:function(t){return 1-Math.sin(1.5708*(1-t))},OUT:function(t){return Math.sin(1.5708*t)},IN_OUT:function(t){return-((Math.cos(3.1416*t)-1)/2)}},/* ******************************************** */Step:{IN:function(t){return 1!=t?0:1},OUT:function(t){return 1!=t?0:1},IN_OUT:function(t){return 1!=t?0:1}}},x=e.extend({list:null,initialData:null,data:null,stack:null,block:null,timeScale:1,time:0,blockTime:0,index:0,paused:!1,finished:!1,onFinishedCallback:null,onUpdatedCallback:null,__ctor:function(){this.list=[],this.initialData={},this.data={},this.stack=[],this.block=this.list,this.reset()},__dtor:function(){},clone:function(){let t=new x;return t.list=this.list,t.initialData=this.initialData,t.reset()},onFinished:function(t){return this.onFinishedCallback=t,this},onUpdated:function(t){return this.onUpdatedCallback=t,this},// Resets the animation to its initial state.
...
*/let q={/**
	...
	*/loadAllAsDataUrl:function(t,e){var s=[];if(!t||!t.length){e(s);return}var n=function(o){if(o==t.length){e(s);return}q.loadAsDataUrl(t[o],function(e,r){r||s.push({name:t[o].name,size:t[o].size,url:e}),n(o+1)})};n(0)},/*
	**	Loads a URL as an image.
	*/loadImageFromUrl:function(t,e){let s=new Image;s.onload=()=>e(s),s.onerror=()=>e(null),s.src=t}};var N=_.register("r-image-cropper",{/*
    ...
    */setImageUrl:function(t){q.loadImageFromUrl(t,t=>{this.setImage(t)})},/*
    **	Sets the image for the cropper from an HTML File object.
    */setImageFile:function(t){q.loadAsDataUrl(t,t=>{q.loadImageFromUrl(t,t=>{this.setImage(t)})})},/*
    ...
    */"event touchmove canvas":function(t){for(let e of t.changedTouches)this.pointerA.id==e.identifier?(this.pointerA.cx=e.clientX,this.pointerA.cy=e.clientY):this.pointerB.id==e.identifier&&(this.pointerB.cx=e.clientX,this.pointerB.cy=e.clientY);if(this.pointerA.active&&this.pointerB.active){let t=Math.sqrt(Math.pow(this.pointerA.sx-this.pointerB.sx,2)+Math.pow(this.pointerA.sy-this.pointerB.sy,2)),e=Math.sqrt(Math.pow(this.pointerA.cx-this.pointerB.cx,2)+Math.pow(this.pointerA.cy-this.pointerB.cy,2));this.imageScale+=(e-t)/10*.025,this.imageScale<.1&&(this.imageScale=.1),this.imageOffsX+=-this.pointerA.ix*this.imageScale+(this.pointerA.cx-this.bounds.left)-this.imageOffsX,this.imageOffsY+=-this.pointerA.iy*this.imageScale+(this.pointerA.cy-this.bounds.top)-this.imageOffsY,this.pointerA.sx=this.pointerA.cx,this.pointerA.sy=this.pointerA.cy,this.pointerB.sx=this.pointerB.cx,this.pointerB.sy=this.pointerB.cy,this.render()}else{let t=this.pointerA.active?this.pointerA:this.pointerB.active?this.pointerB:null;if(!t)return;this.translateImage(t.cx-t.sx,t.cy-t.sy),t.sx=t.cx,t.sy=t.cy}},"event touchstart canvas":function(t){for(let e of(this.imageScale0=this.imageScale,t.changedTouches))null===this.pointerA.id?(this.pointerA.id=e.identifier,this.pointerA.active=!0,this.pointerA.sx=e.clientX,this.pointerA.sy=e.clientY,this.pointerA.ix=(e.clientX-this.bounds.left-this.imageOffsX)/this.imageScale,this.pointerA.iy=(e.clientY-this.bounds.top-this.imageOffsY)/this.imageScale):null===this.pointerB.id&&(this.pointerB.id=e.identifier,this.pointerB.active=!0,this.pointerB.sx=e.clientX,this.pointerB.sy=e.clientY,this.pointerB.ix=(e.clientX-this.bounds.left-this.imageOffsX)/this.imageScale,this.pointerB.iy=(e.clientY-this.bounds.top-this.imageOffsY)/this.imageScale)},"event touchend canvas":function(t){for(let e of t.changedTouches)this.pointerA.id==e.identifier?(this.pointerA.id=null,this.pointerA.active=!1):this.pointerB.id==e.identifier&&(this.pointerB.id=null,this.pointerB.active=!1)},"event touchcancel canvas":function(t){for(let e of t.changedTouches)this.pointerA.id==e.identifier?(this.pointerA.id=null,this.pointerA.active=!1):this.pointerB.id==e.identifier&&(this.pointerB.id=null,this.pointerB.active=!1)}});let M=u,U=f,D=p,$=m,B={/**
     ...
     * @param {object} value
     */setValue:function(t,e,s,n){if(("class"===e[0]||"classList"===e[0])&&(e[0]="className"),e.length>1&&"trait"===e[0]){switch(e[1]){case"valueSignal":case"value":t.onchange=t=>n.set(t.currentTarget.value),D([n],e=>t.value=e);break;case"inputSignal":case"input":t.oninput=t=>n.set(t.currentTarget.value),D([n],e=>t.value=e);break;default:console.error("Unknown trait: "+e[1])}return}// Object used to set `style` or `class` attribute.
if(1===e.length&&"object"==typeof n)switch(e[0]){case"style":for(let e in n)D([e,n[e]],(e,s)=>t.style[e]=s);return;case"className":if(n instanceof Array)D([n],e=>{for(let s in t.className="",e)t.classList.add(e[s])});else for(let e in n)D([e,n[e]],(e,s)=>t.classList[!0==s?"add":"remove"](e));return}// Specific CSS class such as `class:hidden`.
if(2===e.length&&"className"===e[0]){D([e[1],n],(e,s)=>t.classList[!0==s?"add":"remove"](e));return}// Any other attribute/property.
for(let n=0;n<s&&t;n++)t=t[e[n]];t&&D([e[s],n],(e,s)=>t[e]=s)},/**
     * Creates a setter for a specified path inside an object.
     * @param {string[]} path 
     * @returns {(root: Element|Text, value: object) => void}
     */createSetter:function(t){let e=t.length-1;return function(s,n){B.setValue(s,t,e,n)}},/**
...
for(let s of Object.getOwnPropertyNames(t))~~s!=s&&(e[s]=t[s]);return e},/**
     ...
     */cloneNode:function(t,e=!1){if(!e&&!0===t.isCustom)throw Error("cloneNode only available as deep clone for custom elements.");if(e&&!0===t.isCustom)return t.cloneNodeCustom();let s=t.cloneNode();if(e)for(let e of t.childNodes)s.appendChild(B.cloneNode(e,!0));return(// Copy handlers and properties.
B.copyProps(t,s),"oncreated"in s&&s.oncreated(s),s)},/**
     ...
     */ensureNode:function(t,e=!1){if(t instanceof Array){for(let s=0;s<t.length;s++)t[s]=B.ensureNode(t[s],e);return t}return t instanceof Node?e?B.cloneNode(t,!0):t:document.createTextNode(t)},/**
...
if(s instanceof Array){let t=document.createDocumentFragment();o=[],0==s.length&&(s=[document.createTextNode("")]);for(let e=0;e<s.length;e++)o.push(s[e]),t.appendChild(s[e]);r=s[0],s=t}if(!1===n){e.replaceWith(s);let t=document.createComment("");r.parentElement.insertBefore(t,r),o instanceof Array||(o=[o]),o.push(t)}else e.appendChild(s);return o},/**
     ...
     */createReplacer:function(t){return function(e,s){t=B.replaceNode(e,t,B.ensureNode(s))}},/**
...
let n=document.createElement(t),o=[];for(let t=0;t<e.length;t+=2){let s=null;if(s=-1!==e[t].indexOf(":")?e[t].split(":"):[e[t]],e[t+1]!==B.DYNAMIC){B.setValue(n,s,s.length-1,e[t+1]);continue}o.push(B.createSetter(s))}// Attach static children.
let r=[],a=!1,l=!0;// Get indices of dynamic children and detect if any child is a custom element.
for(let t in s)!0===s[t].isCustom&&(a=!0),s[t]===B.DYNAMIC&&r.push(t);// Create and return the element builder fuction.
let h=o.length,c=r.length;return function(t,e,d=null){let u=(e,f=null)=>{let p=null;if(l||a){let t=a?B.cloneNode(n):n;for(let e in s){if(s[e]instanceof Array)throw Error("Document fragments not fully supported!");B.replaceNode(t,t,B.ensureNode(s[e],!0),!0)}a&&(p=t),l=!1}null===p&&(p=B.cloneNode(n,!0));let m="oncreated"in p,g=r.map(t=>B.createReplacer(p.childNodes[t]));for(let e=0;e<h;e++)o[e](p,t[e]);for(let t=0;t<c;t++)D([e[t],t],(t,e)=>g[e](p,t));if(null!==d)for(let t of d)for(let e in t){let s=null;s=-1!==e.indexOf(":")?e.split(":"):[e],B.setValue(p,s,s.length-1,t[e])}return null!==f&&B.copyProps(f,p),!m&&"oncreated"in p&&p.oncreated(p),p.isCustom=!0,p.cloneNode=()=>{throw Error("Use of cloneNode is forbidden in custom elements, use cloneNodeCustom instead.")},p.cloneNodeCustom=()=>u(e.map(t=>t instanceof Node&&!0===t.isCustom?t.cloneNodeCustom():t),p),p};return u(e)}}},H=b,F=_,V=_,Y=E,j=k,X=L,Q=C,z=x,W={Tabs:S,Form:T,Panel:P,List:A,Item:R,Paginator:w,Table:O,Select:I,ImageCropper:N},G=q,K={/**
	 * Database connection.
	 */db:null,/**
	 ...
	 */insert:function(t,e){return this.ensureConnected(),new Promise((s,n)=>{let o=this.db.transaction(t,"readwrite").objectStore(t).add(e);o.onsuccess=t=>{s()},o.onerror=t=>{n(t.target.error)}})}},J=t,Z=e,tt=s,te=n,ti=o,ts=r,tn=a,to=l,tr=h,ta=c;export{H as Router,F as Element,V as CElement,Y as Api,j as DataSource,X as DataList,Q as Easing,z as Anim,W as Elements,G as Utils,K as db,J as Rinn,Z as Class,tt as Event,te as EventDispatcher,ti as Model,ts as ModelList,tn as Schema,to as Flattenable,tr as Collection,ta as Template,M as signal,U as expr,D as watch,$ as validator,B as helpers};//# sourceMappingURL=riza.m.js.map
