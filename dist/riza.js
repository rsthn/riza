...
}),parcelRequire.register("8AUAG",function(t,e){!function(n){// Detect free variables `exports`.
...
*/$0eddb6c9ad6478b4$export$2e2bcd8739ae039=$a5c21812244207c8$export$2e2bcd8739ae039.register("r-table",{source:null,template:null,container:null,isEmpty:null,/**
    ...
    */buildItem:function(t,e){if(this.container.content){let n=this.container.content(e.get());return n.dataset.iid=t,n}let n=this.temporalBody;return n.innerHTML=this.template(e.get()),n.querySelectorAll('[data-model=":list-item"]').forEach(t=>{t.model=e,t.dataset.model="this.model"}),(n=n.firstElementChild).dataset.iid=t,n},/*
    **	Executed when the list is cleared.
...
*/let $56b80282f7eea6ac$var$Utils={/**
	...
	*/showDownload:function(t,e){var n=document.createElement("a");n.href=e,n.style.display="none",n.download=t,n.target="_blank",document.body.appendChild(n),n.click(),document.body.removeChild(n)},/**
	**	Forces the browser to show a file selection dialog.
	*/showFilePicker:function(t,e,n){var s=document.createElement("input");s.type="file",s.accept=e,s.style.display="none",s.multiple=t,document.body.appendChild(s),s.onchange=function(){n(s.files)},document.body.onfocus=function(){document.body.onfocus=null,document.body.removeChild(s)},s.click()},/**
	**	Loads a URL using FileReader and returns as a dataURL.
	*/loadAsDataUrl:function(t,e){var n=new FileReader;n.onload=function(t){e(t.target.result,null)},n.onerror=function(t){e(null,t)},n.readAsDataURL(t)},/**
	**	Loads a URL using FileReader and returns as text.
	*/loadAsText:function(t,e){var n=new FileReader;n.onload=function(t){e(t.target.result)},n.readAsText(t)},/**
	**	Loads a URL using FileReader and returns as an array buffer.
	*/loadAsArrayBuffer:function(t,e){var n=new FileReader;n.onload=function(t){e(t.target.result)},n.readAsArrayBuffer(t)},/**
	**	Loads an array of URLs using FileReader and returns them as data url.
	*/loadAllAsDataUrl:function(t,e){var n=[];if(!t||!t.length){e(n);return}var s=function(r){if(r==t.length){e(n);return}$56b80282f7eea6ac$var$Utils.loadAsDataUrl(t[r],function(e,a){a||n.push({name:t[r].name,size:t[r].size,url:e}),s(r+1)})};s(0)},/*
